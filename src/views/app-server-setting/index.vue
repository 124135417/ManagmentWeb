<template>
    <div class="app-container">
        <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
            ...
            <el-table-column width="180px" align="center" label="应用服务名称">
                <template slot-scope="{row}">
            ...
            <el-table-column width="120px" align="center" label="服务地址">
                <template slot-scope="{row}">
                    <!-- <template v-if="row.edit">
            ...
            <el-table-column min-width="160px" label="服务简介">
                <template slot-scope="{row}">
                    <!-- <template v-if="row.edit">
            ...
            <el-table-column align="center" label="操作" width="120">
                <template slot-scope="{row}">
                    ...
                    <el-dialog title="添加服务" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">

                        <el-form :model="form" label-position="left">
                            <el-form-item label="应用服务名称" :label-width="formLabelWidth">
                                <el-input v-model="row.title" class="edit-input" size="small" />
                            </el-form-item>
